...
if menu == "Home (Predict)":
    st.title("📝 Dyslexia & Handwriting Feature Screening")
    ...
    if blob is not None:
        ...
        # 2️⃣ Handwriting features (3-class)
...
###########################################################
    ...
    st.title("🔬 Deep Analysis: Heatmap, OCR & Errors")
    ...
    if uploaded:
        ...
        # 2️⃣ OCR-like reversal detection
        st.subheader("🔁 Reversal / Inversion Detection")
